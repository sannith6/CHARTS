...
$(document).ready(function () {
        ...
        data.map((item) => {
            ...
            if (item.activity.toUpperCase() === 'DOWNLOAD' || item.activity.toUpperCase() === 'UPLOAD') {
                extraData = `<span style="font-weight:bold;">User Id : </span><span>${item.userid}</span><br/>
                        <span style="font-weight:bold;">Time Of Event : </span><span>${item.eventtime}</span><br/>
                ...
                extraData = `<span style="font-weight:bold;">User Id : </span><span>${item.userid}</span><br/>
            <span style="font-weight:bold;">Time Of Event : </span><span>${item.eventtime}</span><br/>
            <span style="font-weight:bold;">Destination Domain : </span><span>${item.reciever}</span><br/>
            <span style="font-weight:bold;">Sender : </span><span>${item.sender}</span><br/>
            <span style="font-weight:bold;">Reciever : </span><span>${item.destinationDomain}</span><br/>
    ...
    function onClickActivityTimeline(data) {
        ...
        if (data[1] === 'DOWNLOAD' || data[1] === 'UPLOAD') {
            extraData = `<span style="font-weight:bold;">User Id : </span><span>${data[12]}</span><br/>
                        <span style="font-weight:bold;">Time Of Event : </span><span>${data[10]}</span><br/>
                        <span style="font-weight:bold;">Destination Domain : </span><span>${data[7]}</span><br/>
                        <span style="font-weight:bold;">Sent Bytes : </span><span>${data[6]}</span><br/>
            ...
            <span style="font-weight:bold;">Time Of Event : </span><span>${data[10]}</span><br/>
            <span style="font-weight:bold;">Destination Domain : </span><span>${data[7]}</span><br/>
            <span style="font-weight:bold;">Sender : </span><span>${data[6]}</span><br/>
            <span style="font-weight:bold;">Reciever : </span><span>${data[4]}</span><br/>
            <span style="font-weight:bold;">Email Size : </span><span>${data[3]}</span><br/><br/>
            `
        } else if (data[1] === 'LOGON' || data[1] === 'LOGOFF') {
            extraData = `<span style="font-weight:bold;">User Id : </span><span>${data[12]}</span><br/>
            <span style="font-weight:bold;">Time Of Event : </span><span>${data[10]}</span><br/>
            <span style="font-weight:bold;">Destination Domain : </span><span>${data[7]}</span><br/>
            <span style="font-weight:bold;">Reporting Host : </span><span>${data[3]}</span><br/><br/>
            `
        }
        document.getElementById('eventData').innerHTML = extraData
    ...
    controller.update = data => {
        console.log("Check priya >>>>> ", data)
        if (data.length > 0) {
            let responses = []
            var dates = []
            data.map((item) => {
                console.log(item , ">>>>check item here")
                // if (user === item[7]) {
                responses.push({
                    "userid": item[12] ? item[12] : '-',
                    "date": item[10] ? item[10] : '',
                    "eventtime": item[11] ? item[11] : '',
                    "activity": item[3] ? item[3] : '',
                    "destinationDomain": item[8] ? item[8] : '',
                    "emailSize": item[2] ? item[2] : '',
                    "recievedBytes": item[5] ? item[5] : '',
                    "reciever": item[5] ? item[5] : '',
                    "reportingHost": item[5] ? item[5] : '',
                    "sender": item[7] ? item[7] : '',
                    "sentBytes": item[7] ? item[7] : '',
                })
                dates.push(new Date(item[10]))
                // }
            })
