...
// const json = require('medium_january.csv');
...
// let dependencies = ['https://d3js.org/d3.v3.min.js', 'https://d3js.org/d3.geo.projection.v0.min.js', 'https://d3js.org/topojson.v1.min.js']
...
chartContainer.innerHTML = `<div class='row'>
        <div class="col-md-12" style="height:270px;" id="riskyLocationMap">
            <svg id="chart"></svg>
        </div>
</div>`
