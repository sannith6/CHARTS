...
$(document).ready(function () {
    ...
    var k = x.split("%22")
    var userid = k && k[17] ? k[17] : ''
    console.log(k[17], "userid")
    var recurringEvents = {}
    ...
    function displayRecurringEvents(data) {
        ...
        data.map((item) => {
            ...
            if (item.activity.toUpperCase() === 'DOWNLOAD' || item.activity.toUpperCase() === 'UPLOAD') {
                extraData = `<span style="font-weight:bold;">UserId : </span><span>${item.userid}</span><br/>
    ...
    function onClickActivityTimeline(data) {
        ...
        if (data[1] === 'DOWNLOAD' || data[1] === 'UPLOAD') {
            extraData = `<span style="font-weight:bold;">UserId : </span><span>${data[2]}</span><br/>
